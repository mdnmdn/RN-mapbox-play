      ...
      <View style={styles.container}>
        ...
        >
          ...
          <MapboxGL.ShapeSource
            id="calloutLayerSource"
            shape={featureCollection}
          >

            <MapboxGL.SymbolLayer id='callout' style={mapStyles.calloutIcon} />
          </MapboxGL.ShapeSource>
          ...
          >
            <MapboxGL.SymbolLayer id='ico' style={mapStyles.remoteIcon} />
          </MapboxGL.ShapeSource>
